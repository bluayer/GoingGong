...
func (uu *UserUpdate) check() error {
	if v, ok := uu.mutation.PingCnt(); ok {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.PingCnt(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldPingCnt,
		})
	}
	if value, ok := uu.mutation.AddedPingCnt(); ok {
...
// AddPingCnt adds i to the "pingCnt" field.
func (uuo *UserUpdateOne) AddPingCnt(i int) *UserUpdateOne {
	uuo.mutation.AddPingCnt(i)
	return uuo
}
...
func (uuo *UserUpdateOne) check() error {
	if v, ok := uuo.mutation.PingCnt(); ok {
		if err := user.PingCntValidator(v); err != nil {
			return &ValidationError{Name: "pingCnt", err: fmt.Errorf("ent: validator failed for field \"pingCnt\": %w", err)}
		}
	}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.PingCnt(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldPingCnt,
	...
	if value, ok := uuo.mutation.AddedPingCnt(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldPingCnt,
